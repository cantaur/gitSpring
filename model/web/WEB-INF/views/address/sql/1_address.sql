...
insert into ADDRESS values(ADDRESS_SEQ.nextval, '김명훈', '서울시', SYSDATE);
insert into ADDRESS values(ADDRESS_SEQ.nextval, '강정구', '부산시', SYSDATE);
insert into ADDRESS values(ADDRESS_SEQ.nextval, '박소연', '인천시', SYSDATE);
insert into ADDRESS values(ADDRESS_SEQ.nextval, '최민규', '광주시', SYSDATE);
